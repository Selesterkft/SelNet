...
class TransDataFragment:Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        addInputBtn( "Megjegyzés" , "tesztBtn")
        addSignitureBtn("Aláírás","signitureBtn")
        return rootView
    }

    fun addInputBtn( text: String, variableName: String){
    ...
    fun addSignitureBtn( text: String, variableName: String){
        val btn = Button(context)
        btn.layoutParams = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,LinearLayout.LayoutParams.WRAP_CONTENT)
        btn.text = text
        btn.setOnClickListener {
