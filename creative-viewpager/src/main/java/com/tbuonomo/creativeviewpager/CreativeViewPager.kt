...
class CreativeViewPager : FrameLayout {
    ...
    private fun readAttributes(attrs: AttributeSet?) {
        if (attrs != null) {
            val ta: TypedArray =
                context.obtainStyledAttributes(attrs, R.styleable.CreativeViewPager)

            headerItemSize =
                ta.getDimension(R.styleable.CreativeViewPager_headerItemSize, headerItemSize)
            headerItemMargin = ta.getDimension(
                R.styleable.CreativeViewPager_headerItemMargin,
                headerItemMargin
            )
            contentItemMargin = ta.getDimension(
                R.styleable.CreativeViewPager_contentItemMargin,
                contentItemMargin
            )
    ...
    private fun setUpEditMode() {
        ...
        editModeContentLayout.setPadding(
        ...
        for (i in 0..10) {
            ...
            val marginLayoutParams =
                MarginLayoutParams(headerItemSize.toInt(), headerItemSize.toInt())
            val layoutParams = headerGuideline.layoutParams as ConstraintLayout.LayoutParams
            val parentMargin =
                layoutParams.guidePercent * context.resources.displayMetrics.widthPixels
            if (i == 0) {
    ...
    private fun setUpContent() {
        // Contents
        creativeContentAdapter = CreativeContentAdapter(
            this, contentItemMargin,
            contentHorizontalPadding
        )
        creativeContentViewPager.setPageTransformer(
            false,
    ...
    private fun setUpHeader() {
        ...
        creativeImageAdapter = CreativeHeaderAdapter(
            this, headerGuideline, headerItemSize,
            headerItemMargin
        )
        {
    ...
    fun setCreativeViewPagerAdapter(creativePagerAdapter: CreativePagerAdapter) {
        post {
            ...
            creativeHeaderRecycler.layoutManager = LinearLayoutManager(
                context,
